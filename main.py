...
TIMEFRAMES = {
    "5m": {"interval": "5", "candles": 10000},
    "15m": {"interval": "15", "candles": 10000},
    "30m": {"interval": "30", "candles": 10000},
    "1h": {"interval": "60", "candles": 10000},
    "4h": {"interval": "240", "candles": 10000},
    "1d": {"interval": "D", "candles": 2000},
}
...
def fetch_candles(symbol, interval, total_needed):
    all_candles = []
    ...
    while len(all_candles) < total_needed:
        ...
        print(f"{symbol} {interval} | Downloaded {len(all_candles)} candles")
...
for pair in PAIRS:
    for tf_name, tf_info in TIMEFRAMES.items():
        ...
        # Create dictionary variable dynamically
        dict_name = f"{pair}_{tf_name}"
        globals()[dict_name] = df.to_dict("records")

        # Save CSV
        filename = f"{pair}_{tf_name}.csv"
        df.to_csv(filename, index=False)

        print(f"Saved {filename}")

print("\n✅ DONE — All files saved in current directory.")
